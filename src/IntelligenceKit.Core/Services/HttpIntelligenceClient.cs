...
/// <summary>
/// Default <see cref="IIntelligenceClient"/>: posts events (JSON) and screenshots
/// (raw JPEG) to the server named in the DSN, classifying responses for the
/// store-and-forward uploader. Shared by every platform SDK.
/// </summary>
